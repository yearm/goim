...
func (s *Service) ReadPump(c *WsClient) {
	defer func() {
		// 设备离线
...
func (s *Service) WritePump(c *WsClient) {
...
// 存储客户端连接
func (s *Service) storeWsClient(token string, wsConn *WsClient) {
	s.manager.Set(token, wsConn)
}

// 获取客户端连接
func (s *Service) loadWsClient(token string) *WsClient {
...
// 删除客户端连接
func (s *Service) deleteWsClient(token string) {
